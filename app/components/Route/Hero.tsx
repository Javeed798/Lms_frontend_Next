    ...
    return (
        ...
        <div className={"absolute ml-32 top-[100px] 1000px:top-[unset] 1500px:w-[700px] 1100px:h-[600px] h-[50vh] w-[40vh] hero_animation duration-300 transition-all  rounded-full "}> </div>
            ...
            <div className={"1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]  "}>
                <h2 className={"dark:text-white -ml-20 text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[70px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[50%]"}>
                ...
                <div className={"1500px:w-[55%] 1100px:w-[78px] w-[90%] h-[50px] bg-transparent relative "}>
                    ...
                    className={"bg-transparent dark:text-white border dark:border-none dark-bg-[#575757] dark:placeholder:text-[#ffffffdd] rounded-[5px] p-2 w-full h-full outline-none text-black  "}
                    />
